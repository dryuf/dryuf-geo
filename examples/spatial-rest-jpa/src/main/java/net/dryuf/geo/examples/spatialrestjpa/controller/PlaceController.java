...
import net.dryuf.geo.examples.spatialrestjpa.model.Place;
import net.dryuf.geo.examples.spatialrestjpa.spatialdb.model.PlaceDb;
import net.dryuf.geo.examples.spatialrestjpa.spatialdb.repository.PlaceRepository;
